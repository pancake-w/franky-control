...
class GripperController:
    ...
    def close(self, speed: float = 0.1, force: float = 40.0) -> bool:
        """
    ...
    def move(self, width: float, speed: float = 0.05) -> bool:
        """
    ...
    def grasp(
        ...
        Returns:
            bool: True if object successfully grasped
        """
        if not self._is_homed:
            print("[Gripper] Warning: Gripper not homed, calling home() first")
            self.home()
